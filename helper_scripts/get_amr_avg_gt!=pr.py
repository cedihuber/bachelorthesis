...
def main(args):
    ...
    with open(args.output, 'w', newline='') as f2:
        ...
        for a in range(40):
            ...
            # select rows where ground truth and prediction have opposite sign
            sub_df = df_attr[df_attr['ground truth'] * df_attr['prediction'] < 0]
            # calculate average of amr
            avg = sub_df['amr corrected'].mean()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Get average acceptable mask ratio for incorrectly classified samples of each attribute.")
    parser.add_argument(
        'input',
        type=str,
