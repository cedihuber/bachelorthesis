...
def main(args):
    ...
    with open(args.output, 'w', newline='') as f2:
        ...
        for a in range(40):
            ...
            # select rows where ground truth and prediction have the same sign
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Get average acceptable mask ratio for correctly classified samples of each attribute.")
    parser.add_argument(
        'input',
        type=str,
