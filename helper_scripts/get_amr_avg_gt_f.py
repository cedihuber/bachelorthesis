...
def main(args):
    ...
    with open(args.output, 'w', newline='') as f2:
        ...
        for a in range(40):
            ...
            df_gt_false= df_attr[df_attr['ground truth'] == -1]
            # calculate average of amr
            avg = df_gt_false['amr corrected'].mean()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Get average acceptable mask ratio for the case of absence of an attribute")
    parser.add_argument(
        'input',
        type=str,
