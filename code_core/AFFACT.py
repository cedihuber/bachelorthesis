...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.attributes_1 = self.__dense(name = 'attributes_1', in_features = 1000, out_features = 40, bias = True)
    ...
    def forward(self, x):
        ...
        # insert identity layer to obtain the data from res5c
        ...
        attributes_0    = fc1000_1.view(fc1000_1.size(0), -1)
        attributes_1    = self.attributes_1(attributes_0)
        return attributes_1
