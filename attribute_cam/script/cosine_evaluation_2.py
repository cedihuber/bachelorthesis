...
def command_line_options():
  ...
  parser.add_argument(
      ...
      default='../../../../local/scratch/chuber/Finalresults/unbalanced/corrRise_masks_black_3000_masks_30_patch',
      help="Select directory containing the input dataset"
  )
  parser.add_argument(
  ...
  parser.add_argument(
      "-l", "--latex-file",
      default="../../../../local/scratch/chuber/Finalresults/balanced/corrRise_masks_black_3000_masks_30_patch/cosine_similarity_balanced_unbalanced.tex",
