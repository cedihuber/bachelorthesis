...
def command_line_options():
  ...
  parser.add_argument(
      '-o', '--output-directory',
      default="../../../../local/scratch/chuber/corrRiseStyles/balanced/corrRise_masks_black_4000_masks_30_patch", #corrRiseResult/unbalanced/
...
def main():
  ...
  for key_p, value_p in prediction.items():
